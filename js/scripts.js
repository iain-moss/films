...
async function cards() {
    let data = await d3.csv("../data/scraping/all_letterboxd.csv", d3.autoType);
    data.sort((a, b) => d3.descending(a.date_rated, b.date_rated));

    let genreList = await d3.csv("../data/scraping/genre_list.csv");
    let countries = await d3.csv("../data/scraping/countries.csv");
...
async function releaseYear() {
    ...
    const data = await d3.csv("../data/scraping/release_year.csv", d => ({
...
async function dirBar() {
    const data = await d3.csv("../data/scraping/dir_bar.csv", d3.autoType);
    let allData = await d3.csv("../data/scraping/test.csv", d3.autoType);
...
async function watchDate() {
    ...
    const data = await d3.csv("../data/scraping/watch_date.csv", d => ({
...
async function decadeScatter() {
    const data = await d3.csv("../data/scraping/decade_breakdown.csv", d => ({
        decade: d.decade,
